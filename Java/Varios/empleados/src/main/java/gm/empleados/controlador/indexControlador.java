...
public class indexControlador {
    ...
    @RequestMapping(value = "/", method = RequestMethod.GET) //Introducimos la url a procesar
    public String iniciar(ModelMap modelo){
        ...
        return "index";// Devolvemos el index.jps
    }
    ...
    public String agregar(@ModelAttribute("empleadoForma") Empleado empleado, HttpServletRequest request){
        ...
        return "redirect:/";//Redirige al path del inicio
    }
    ...
    public String modificar(@ModelAttribute("empleadoForma") Empleado empleado, HttpServletRequest request){
